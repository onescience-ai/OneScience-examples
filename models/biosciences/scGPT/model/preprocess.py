"""Self-contained preprocessing helpers used by the scGPT model package.

Extracted from ``onescience.datapipes.scgpt.preprocess`` so that the
``model/`` directory does not depend on the installed ``onescience`` package.
"""
