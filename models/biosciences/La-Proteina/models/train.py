...
from .utils.ema_callback import EMA, EmaModelCheckpoint
from .utils.fetch_last_ckpt import fetch_last_ckpt
from .utils.fold_utils import (
    transform_global_percentage_to_mask_dropout,
)
from .utils.lora_utils import replace_lora_layers
from .utils.seed_callback import SeedCallback
from .utils.training_analysis_utils import (
...
def load_cfg_exp(config_name, single_gpu, is_cluster_run):
    ...
    """
    config_path = str(CONFIG_ROOT / "experiment_config")
...
def main(cfg_exp) -> None:
    ...
    nolog = cfg_exp.get(
        "nolog", False
    )  # To use do `python -m onescience.models.laproteina.train +nolog=true`
