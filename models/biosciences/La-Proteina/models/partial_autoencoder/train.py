...
from models.utils.ema_callback import EMA, EmaModelCheckpoint
from models.utils.fetch_last_ckpt import fetch_last_ckpt
from models.utils.seed_callback import SeedCallback
from models.utils.training_analysis_utils import (
...
@hydra.main(
    version_base=None,
    config_path="../../../configs/bio/laproteina",
...
def main(cfg_exp) -> None:
    ...
    nolog = cfg_exp.get(
        "nolog", False
    )  # To use do `python -m onescience.models.laproteina.partial_autoencoder.train +nolog=true`
