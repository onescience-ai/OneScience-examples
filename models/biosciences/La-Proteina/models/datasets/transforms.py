...
from onescience.datapipes.openfold import data_transforms
from onescience.utils.openfold.np import residue_constants
from onescience.utils.openfold import rigid_utils
from models.utils.align_utils import mean_w_mask
from models.utils.constants import SIDECHAIN_TIP_ATOMS
from models.utils.coors_utils import ang_to_nm, sample_uniform_rotation
...
class ChainBreakPerResidueTransform(T.BaseTransform):
    ...
    def forward(self, graph: Data) -> Data:
        """Required by PyG BaseTransform abstract class."""
        return self.__call__(graph)
