...
from onescience.datapipes.state.embedding.loader import H5adSentenceDataset, VCIDatasetSentenceCollator
from onescience.utils.state.callbacks.embedding import (
    LogLR,
    ProfilerCallback,
    ResumeCallback,
    EMACallback,
...
from onescience.utils.state.embedding import get_dataset_cfg, get_embedding_cfg, get_embeddings, get_latest_checkpoint
...
def main(cfg):
    ...
    max_steps = cfg.experiment.get("max_steps", -1)
