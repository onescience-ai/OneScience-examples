...
from scripts.data.airfrans_dataset import AirfRANSDataPipe
from model.infinity import INFINITY
from scripts.eval.metrics import evaluate


def main(config_path="config/infinity.yaml"):
...
if __name__ == "__main__":
    import torch
    cfg = sys.argv[1] if len(sys.argv) > 1 else "config/infinity.yaml"
    main(cfg)
