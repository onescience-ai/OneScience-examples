...
AURORA 是微软研究院提出的地球系统基础模型，可完成全球天气预报、空气污染预测等多种地球系统预测任务，相关论文发表于 ICML 2024。
...
Aurora是一个拥有13亿参数的大型深度学习模型，由三维感知编码器、三维Swin Transformer处理器，动态解码器组成。
...
```bash
modelscope download --model OneScience/AURORA --local_dir ./AURORA
cd AURORA
```
