"""
Evaluation wrapper for the ConvNeXt-Tiny model.

Exposes get_model(metadata) as required by evaluate.py.
...
CHECKPOINT_PATH = ROOT / "runs" / "convnext_tiny" / "checkpoints" / "best.pt"
...
def get_model(metadata):
    ...
    model = ConvNeXtBaseline(n_input_channels=n_vars, n_targets=6)
