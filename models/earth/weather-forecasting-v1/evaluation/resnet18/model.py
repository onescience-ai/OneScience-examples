"""
Evaluation wrapper for the ResNet-18 model.
...
CHECKPOINT_PATH = ROOT / "runs" / "resnet18" / "checkpoints" / "best.pt"
...
def get_model(metadata):
    ...
    model = ResNet18Baseline(n_input_channels=n_vars, n_targets=6)
