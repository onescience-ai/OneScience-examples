...
from onescience.modules.layer.equiformer_v3.so3 import SO3Linear
...
class EquiformerV3DeNS_OC(EquiformerV3_OC):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            lmax=lmax,
            mmax=mmax,
            attn_grid_resolution_list=attn_grid_resolution_list,
            ffn_grid_resolution_list=ffn_grid_resolution_list,
            ...
            use_gate_force_head=use_gate_force_head,
            ...
            proj_drop=proj_drop,
            ffn_drop=ffn_drop,
            use_head_reg=use_head_reg,
            gradient_checkpointing_block_list=gradient_checkpointing_block_list,
